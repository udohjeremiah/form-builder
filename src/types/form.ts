...
export const FIELD_TYPES: { icon: string; label: string; type: FieldType }[] = [
  ...
  { icon: "MailIcon", label: "Email", type: "email" },
  { icon: "LockIcon", label: "Password", type: "password" },
  { icon: "HashIcon", label: "Number", type: "number" },
  { icon: "PhoneIcon", label: "Phone", type: "phone" },
  { icon: "LinkIcon", label: "URL", type: "url" },
  { icon: "AlignLeftIcon", label: "Textarea", type: "textarea" },
  { icon: "ChevronDownIcon", label: "Select", type: "select" },
  { icon: "CheckSquareIcon", label: "Checkbox", type: "checkbox" },
  { icon: "CircleIcon", label: "Radio", type: "radio" },
  { icon: "CalendarIcon", label: "Date", type: "date" },
  { icon: "CalendarClockIcon", label: "Date & Time", type: "datetime" },
  { icon: "ClockIcon", label: "Time", type: "time" },
  { icon: "UploadIcon", label: "File", type: "file" },
  { icon: "ToggleLeftIcon", label: "Toggle", type: "toggle" },
  { icon: "SlidersHorizontalIcon", label: "Slider", type: "slider" },
  { icon: "StarIcon", label: "Rating", type: "rating" },
  { icon: "PaletteIcon", label: "Color", type: "color" },
  { icon: "EyeOffIcon", label: "Hidden", type: "hidden" },
  { icon: "HeadingIcon", label: "Heading", type: "heading" },
  { icon: "FileTextIcon", label: "Paragraph", type: "paragraph" },
  { icon: "MinusIcon", label: "Divider", type: "separator" },
];
